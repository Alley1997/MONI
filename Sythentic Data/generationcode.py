...
def generate_synthetic_data(n=10000):
    ...
    data = {
        ...
        'CollectionDate': [random_date(start_date, end_date).strftime('%Y-%m-%d') for _ in range(n)],
...
print("Synthetic dataset with 10,000 records created and saved as 'synthetic_malaria_one_health_data.csv'.")
